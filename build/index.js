...
module.exports = function (input) {
	if (!(input instanceof Uint8Array || Buffer.isBuffer(input))) {
		throw new TypeError('Expected the `input` argument to be of type `Uint8Array` or `Buffer`, got `' + (typeof input === 'undefined' ? 'undefined' : _typeof(input)) + '`');
	}
	...
	if (check([0x0, 0x0, 0x0, 0x14, 0x66, 0x74, 0x79, 0x70, 0x71, 0x74, 0x20, 0x20]) || check([0x66, 0x72, 0x65, 0x65], { offset: 4 }) || // Type: `free`
	check([0x66, 0x74, 0x79, 0x70, 0x71, 0x74, 0x20, 0x20], { offset: 4 }) || check([0x6D, 0x64, 0x61, 0x74], { offset: 4 }) || // MJPEG
	...
	if (check([0x30, 0x26, 0xB2, 0x75, 0x8E, 0x66, 0xCF, 0x11, 0xA6, 0xD9])) {
		...
		do {
			...
			if (check([0x91, 0x07, 0xDC, 0xB7, 0xB7, 0xA9, 0xCF, 0x11, 0x8E, 0xE6, 0x00, 0xC0, 0x0C, 0x20, 0x53, 0x65], { offset: _offset })) {
				...
				if (check([0x40, 0x9E, 0x69, 0xF8, 0x4D, 0x5B, 0xCF, 0x11, 0xA8, 0xFD, 0x00, 0x80, 0x5F, 0x5C, 0x44, 0x2B], { offset: _offset + 24 })) {
					// Found audio:
					return {
						ext: 'wma',
						mime: 'audio/x-ms-wma'
				...
				if (check([0xC0, 0xEF, 0x19, 0xBC, 0x4D, 0x5B, 0xCF, 0x11, 0xA8, 0xFD, 0x00, 0x80, 0x5F, 0x5C, 0x44, 0x2B], { offset: _offset + 24 })) {
					// Found video:
					return {
						ext: 'wmv',
						mime: 'video/x-ms-asf'
